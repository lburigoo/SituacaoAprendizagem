...
echo Please set the JAVA_HOME variable in your environment to >&2
echo point to the location of your Java installation. >&2
echo.
goto error
...
for /F %%s in ("%MAVEN_PROJECTBASEDIR%\.mvn\jvm.config") do set JVM_CONFIG_MAVEN_PROPS=!JVM_CONFIG_MAVEN_PROPS! %%s
